...
public class MutableServiceReferenceComponentMetadataTest {
	...
	private MutableServiceReferenceComponentMetadata sr = new MutableServiceReferenceComponentMetadata("foo") {
	};
	...
	public void testInterfaces() throws Exception {
		assertEquals(0, sr.getInterfaceNames().size());
	...
	public void testListeners() throws Exception {
		assertEquals(0, sr.getBindingListeners().size());
