 ...
 * 
 */
public class MutableLocalComponentMetadata extends MutableComponentMetadata implements LocalComponentMetadata {
	...
	public void setConstructorMetadata(ConstructorInjectionMetadata constructorMetadata) {
	...
	public void setMethodInjectionMetadata(MethodInjectionMetadata[] methodInjectionMetadata) {
	...
	public Collection getPropertyInjectionMetadata() {
		return Collections.unmodifiableList(Arrays.asList(this.propertyMetadata));
	}
