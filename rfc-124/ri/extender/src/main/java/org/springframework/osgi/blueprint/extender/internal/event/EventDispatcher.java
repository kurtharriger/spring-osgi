...
/**
 * Dispatcher of {@link OsgiBundleApplicationContextEvent events}. Normally
 * used as an adapter to other event infrastructure such as
 * {@link org.springframework.context.EventAdmin}. If the need arises, this
 * interface might be promoted and moved into Spring DM core.
 * 
 * @author Costin Leau
 */
