 ...
 * 
 */
public class ModuleContextConfig extends ApplicationContextConfiguration {

	/** logger */
	private static final Log log = LogFactory.getLog(ModuleContextConfig.class);
	...
	public ModuleContextConfig(Bundle bundle) {
