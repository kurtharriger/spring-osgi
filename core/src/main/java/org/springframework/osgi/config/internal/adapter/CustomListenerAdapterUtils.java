...
public abstract class CustomListenerAdapterUtils {
	...
	/**
	 * Specialized reflection utility that determines all methods that accept two parameters such:
	 * 
	 * <pre> methodName(Type serviceType, Type1 arg) methodName(Type serviceType, Type2 arg) methodName(AnotherType
	 * serviceType, Type1 arg). </pre>
	 * 
	...
	/**
	 * Shortcut method that uses as possible argument types, Dictionary.class or Map.class.
	 * 
	 * @param target
	 * @param methodName
	 * @return
