...
/**
 * Exporter-only delegate (it would be nice to have generics).
 * 
 * @author Costin Leau
 * 
 */
public abstract class ExporterRegistry {
	...
	public static void putController(Object slave, ExporterInternalActions master) {
		delegate.putController(slave, master);
	}

	public static ExporterInternalActions getControllerFor(Object slave) {
		return (ExporterInternalActions) delegate.getControllerFor(slave);
	}
