...
import org.springframework.osgi.service.dep.internal.DefaultMandatoryDependencyManager;

/**
 * Unit test checking the dependencies between mandatory importers and
 * exporters.
 * 
 * @author Costin Leau
 * 
