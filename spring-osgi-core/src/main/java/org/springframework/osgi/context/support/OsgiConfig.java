    ...
    public static class ConfigListener {
        ...
        void resolve(BeanFactory beanFactory, boolean isFactory) {
            ...
            if (isFactory) {
                try {
                    ...
                    throw new IllegalArgumentException("Invalid or missing update method for bean " + reference
                                                       + "; requires signature (java.lang.String, java.util.Map)", e);
                }
            } else {
                try {
            ...
            if (deletedMethod != null) {
                try {
                    ...
                    throw new IllegalArgumentException("Invalid or missing deleted method for bean " + reference
                                                       + "; requires signature (java.lang.String)", e);
                }
            }
        }
        ...
        void deleted(String instancePid) {
            ...
            try {
                ...
                throw new IllegalStateException("Invalid or missing deleted method for bean " + reference
                                                + "; requires signature (java.lang.String)", e);
            }
            ...
            try {
                ...
                throw new IllegalStateException("Insufficient permission to invoke deleted method", e);
            } catch (InvocationTargetException e) {
                throw new IllegalStateException("Error deleting", e.getTargetException());
            }
        }
    }
}
