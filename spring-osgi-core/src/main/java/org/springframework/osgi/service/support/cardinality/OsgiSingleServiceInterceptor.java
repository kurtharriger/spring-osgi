 ...
 * 
 */
public class OsgiSingleServiceInterceptor extends AbstractOsgiServiceInterceptor {

	private boolean mandatoryEnd;

	private ServiceWrapper wrapper;

	public OsgiSingleServiceInterceptor() {
		this(true);
	}

	public OsgiSingleServiceInterceptor(boolean mandatoryEnd) {
