 ...
 * 
 */
public class AutoJUnitTestActivator implements BundleActivator {

	private static final Log log = LogFactory.getLog(AutoJUnitTestActivator.class);
	...
	public void start(BundleContext bc) throws Exception {
		...
		registration = context.registerService(AutoJUnitTestActivator.class.getName(), this, new Hashtable());
		System.out.println("starting test execution");
		System.out.println("trying to get reference to self " + context.getServiceReference(AutoJUnitTestActivator.class.getName()));
		System.getProperties().put(OsgiJUnitTest.OSGI_TEST, "org.springframework.osgi.iandt.io.ClassSpaceTest");
		executeTest();
	}
