 ...
 * @author Costin Leau
 */
public class ConfigurationTest extends BaseBlueprintIntegrationTest {

	@Override
	protected String[] getTestBundlesNames() {
		return new String[] { "org.springframework.osgi.iandt.blueprint,config.bundle," + getSpringDMVersion() };
	}
