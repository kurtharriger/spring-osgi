...
public class ComponentScanTest extends BaseIntegrationTest {
	...
	protected String[] getConfigLocations() {
		return new String[] { "/org/springframework/osgi/iandt/jdk5/io/component-scan.xml" };
	}

	protected String[] getTestBundlesNames() {
		return new String[] { "org.springframework.osgi.iandt,component.scan.bundle," + getSpringDMVersion() };
	}
