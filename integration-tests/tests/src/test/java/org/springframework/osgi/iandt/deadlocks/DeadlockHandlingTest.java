...
public class DeadlockHandlingTest extends AbstractConfigurableBundleCreatorTests {
     ...
     * happens when the OSGi framework is shutdown while the Spring/OSGi extender is deadlocked.
     * If all goes well, the test will gracefully end.  If not, it will hang for quite a while.
     */
    public void testErrorHandling() throws Exception {
        ...
        AbstractRefreshableApplicationContext appContext =
                (AbstractRefreshableApplicationContext) tracker.waitForService(3000);
